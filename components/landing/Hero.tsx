...
export default function Hero() {
  return (
    <section id="inicio" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 pt-28 w-full">
        <div className="flex flex-col items-center text-center">
          ...
          <a
            href="/admin/login"
            className="mt-8 inline-flex items-center gap-1.5 border border-white/30 rounded-lg px-3 py-1.5 text-xs text-white/70 hover:text-white hover:border-white/50 transition-colors"
          >
            <Lock size={11} />
